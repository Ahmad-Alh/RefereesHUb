    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-white mb-2">تم إنشاء حساب المسؤول</h2>
          <p className="text-gray-400 mb-6">يمكنك الآن تسجيل الدخول بالبيانات التي أدخلتها</p>
          <a
            href="/admin"
    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-white">تهيئة حساب المسؤول</h1>
          <p className="text-gray-500 text-sm mt-1">يُستخدم مرة واحدة فقط لإنشاء الحساب الأول</p>
        </div>

        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
          {error && (
            <div className="mb-4 p-3 bg-red-950 border border-red-800 rounded-lg flex items-center gap-2 text-red-400 text-sm">
            ...
            {[
              ...
              <div key={key}>
                ...
                <input
                  ...
                  className="w-full bg-gray-800 border border-gray-700 text-white px-3 py-2.5 rounded-lg text-sm placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-green-600"
