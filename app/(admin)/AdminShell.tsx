...
import { Video, FileQuestion, BarChart2, Shield, Menu, X, FolderOpen } from 'lucide-react'
  ...
  return (
    <aside className="flex flex-col h-full bg-white border-l border-gray-200 w-56">
      ...
      <div className="p-3 border-t border-gray-200 space-y-1">
        ...
        <div className="w-full px-3 py-2.5 rounded-lg text-xs text-amber-700 bg-amber-50 border border-amber-200">
